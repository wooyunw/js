...
var
    fed = (_fed = {}, _defineProperty(_fed, "global", (_ref2 = {}, _defineProperty(_ref2, "init", function () {
        ...
        $(".fed-part-height")["height"]($(".fed-part-height")["height"]()), fed["cookie"]["get"]("user_id") != void 0 && fed["cookie"]["get"]("user_id") != "" && ($(".fed-navs-login")["addClass"]("fed-navs-user fed-event")["removeClass"]("fed-navs-login")["html"]('我的<span class="fed-part-move fed-edge-info fed-edge-bottom"></span>'),
        ...
        new Swiper(".fed-swip-container", (e = {}, _defineProperty(e, "wrapperClass", "fed-swip-wrapper"), _defineProperty(e, "slideClass", "fed-swip-slide"), _defineProperty(e, "pagination", ".fed-swip-pagin"), _defineProperty(e, "bulletClass", "fed-swip-bullet"), _defineProperty(e, "bulletActiveClass", "fed-swip-this"), _defineProperty(e, "nextButton", ".fed-swip-next"), _defineProperty(e, "prevButton", ".fed-swip-prev"), _defineProperty(e, "paginationClickable", !0), _defineProperty(e, "lazyLoading", !0),

            _defineProperty(e, "lazyLoadingClass", "fed-swip-lazy"),
            _defineProperty(e, "lazyLoadingInPrevNext", !0),
            _defineProperty(e, "autoplay", 5e3),
            _defineProperty(e, "loop", !0), e))
        ...
        $(document).on("input,textarea", function () {
            ...
            $('.fed-navs-input').removeClass('fed-rims-reds'), $('.fed-pops-btns').removeClass('fed-pops-tops'), $('.fed-pops-channel').removeClass('fed-show'), $('.fed-navs-search,.fed-navs-close').removeClass('fed-show'), $('.fed-pops-navbar ul li').removeClass('fed-line-top fed-line-right'), fed.global.dels('.fed-part-mask,.fed-mode-info'), $('.fed-goto-info').show(), $('.fed-conceal').hide(), fed.navbar.closes(), fed.navbar.trigon()
        })
    ...
    }), _defineProperty(_ref2, 'vers', 'vfed 3.1(苹果CMSv10)'), _defineProperty(_ref2, 'jump', 'http://vfed.cc'), _defineProperty(_ref2, 'tips', function (e) {
        alert(e)
        ...
        $('.fed-navs-btns').click(function () {
            ...
            $('.fed-navs-name').attr('data-type', $(this).attr('data-type')).attr('data-href', $(this).attr('data-href')).text($(this).text()), $('.fed-pops-cuts li').removeClass('fed-text-green'), $(this).addClass('fed-text-green'), $('.fed-navs-search,.fed-pops-search,.fed-navs-close').show(), $('.fed-navs-search .fed-navs-input').val("").focus(), $('.fed-navs-search,.fed-navs-close').removeClass('fed-show'), $('.fed-pops-key').hide(), $('.fed-pops-box').show()
        }), $(e).click(function () {
        ...
        if (1 == $(e).attr('data-chat')) fed.cookie.get('fed_wechat') ? w.src = m : $('.fed-chat-info').show(), $(document).on('click', '.fed-chat-submit', function () {
            return fed.base64.decode($(e).attr('data-word')) == $('.fed-chat-input').val() ? void (fed.cookie.set('fed_wechat', $(e).attr('data-word'), 1), $('.fed-chat-info').hide(), w.src = m) : ($('.fed-chat-input').val("").attr('placeholder', '口令错误！请重新输入').focus(), !1)
        ...
        fed.global.submit('.fed-rage-submit', '.fed-play-boxs'), $(document).on('click', '.fed-rage-submit', function () {
            ...
            $.post(vfed.tpl + ('asset/fed/create.php?id=dan'), 'id=' + vfed.did + ('&user=') + $('.fed-rage-input').attr('data-user') + ('&name=') + $('.fed-rage-input').attr('data-name') + ('&info=') + $('.fed-rage-input').val() + ('&time=') + Date.parse(new Date) / 1e3, function (g) {
                if (1 == g.msg) {
                    ...
                    var F = 9;
                    $('.fed-rage-input').val("").attr('placeholder', '发送成功'), $('.fed-rage-common').text(0 >= F ? '发送' : '骚等10').addClass('fed-btns-disad');
        ...
        if (_0xae48x4e0 != void 0) var _0xae48x4de = eval(_0xae48x4e0);
        var _0xae48x183 = "";
        if (0 < _0xae48x4de.length) for (var ii = 0; ii < _0xae48x4de.length; ii++) _0xae48x183 += '<li class="fed-part-rows fed-line-bottom"><a class="fed-part-rows" href="' + _0xae48x4de[ii].link + ('"><span class="fed-part-e' + 'on' + 'e fed-col-xs9">') + _0xae48x4de[ii].name + ('<span class="fed-text-muted">[') + _0xae48x4de[ii].num + (']</span></span><span class="fed-part-eone fed-text-muted fed-text-right fed-col-xs3">') + _0xae48x4de[ii].show + ('</span></a></li>'); else _0xae48x183 += '<li class="fed-part-rows fed-line-bottom"><a class="fed-part-rows" href="javascript:;">暂无观看记录</a></li>';
